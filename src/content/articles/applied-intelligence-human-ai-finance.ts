...
export const articleAppliedIntelligence: NewsletterArticle = {
  ...
  tags: ["Applied Intelligence", "FP&A", "AI Strategy", "Human + AI", "CFO Leadership", "Scenario Planning"],
  ...
  metricsHighlight: [
    ...
    { label: "C-Suite AI Mandate", value: "70%", change: "Vena FP&A Impact Report", isPositive: true },
    { label: "FP&A Agent Assistance", value: "33%+", change: "Processes automated within 2 yrs", isPositive: true }
  ],
  keyTakeaways: [
    "Artificial Intelligence provides the computational engine, but Applied Intelligence produces real business outcomes through human context and judgment.",
    "Over 87% of finance leaders anticipate AI will fundamentally reconfigure finance workflows rather than simply cut headcount.",
    "In FP&A, AI shifts finance teams from spending 80% of time gathering data to 80% testing hypotheses and providing strategic advisory.",
    "Commoditized LLM access means tools alone offer no moat; organizational competitive advantage lies in prompt orchestration and execution.",
    "Effective governance requires setting firm guardrails around data privacy, model explainability, and algorithmic bias."
  ],
  sections: [
    {
      heading: "The Inflection Point: Moving from Defensive Stance to Strategic Orchestration",
      paragraphs: [
      ...
      callout: {
        type: "insight",
        title: "The Core Paradigm",
        text: "Artificial Intelligence provides the computational engine, but Applied Intelligence is created when algorithmic velocity is paired with human context, qualitative judgment, and strategic orchestration. AI yields intelligence; human leadership delivers impact."
      }
    },
    {
      heading: "Defining the Shift: Artificial Intelligence vs. Applied Intelligence",
      paragraphs: [
      ...
      table: {
        headers: ["Dimension", "Artificial Intelligence (The Engine)", "Applied Intelligence (The Synergy)"],
        rows: [
    ...
    {
      heading: "Applied Intelligence in Action: Three Key FP&A Use Cases",
      paragraphs: [
    ...
    {
      heading: "The Four Pillars of the Human + AI Equation in Finance",
      paragraphs: [
      ...
      quote: {
        text: "Artificial Intelligence provides the capability; Applied Intelligence produces the outcome. AI is the engine, but human judgment remains the navigator.",
        author: "Atul Kulshreshtha",
        role: "Founder & Managing Partner, GroByz Partners"
      },
      checklist: [
        "Reallocate FP&A analyst bandwidth from data preparation to commercial decision support",
        "Implement continuous Monte Carlo scenario modeling for multi-variable capital allocation",
        "Anchor algorithmic forecast models with qualitative operational context",
        "Establish zero-retention data privacy guardrails and model explainability standards",
        "Train finance controllers on advanced prompt orchestration and AI audit verification"
      ]
    }
  ],
  conclusion: {
