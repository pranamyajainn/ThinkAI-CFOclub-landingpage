...
/**
 * Returns all standalone articles sorted by publication date (most recent first)
 */
 ...
 */
export function searchArticles(query: string, category: ArticleCategory = "All"): Article[] {
