...
import { Sparkles, BookOpen, TrendingUp, ShieldCheck } from "lucide-react";

interface ArticlesHeroProps {
  totalArticles: number;
}

export default function ArticlesHero({ totalArticles }: ArticlesHeroProps) {
  return (
    <section className="relative pt-32 pb-16 px-6 overflow-hidden bg-gradient-to-b from-surface via-surface-container-low to-surface">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span>Standalone Practitioner Articles</span>
        </motion.div>
        ...
        >
          Operational teardowns, algorithmic risk frameworks, and real-world deployment case studies curated specifically for CFOs and senior finance leaders.
        </motion.p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>{totalArticles} {totalArticles === 1 ? "Article" : "Articles"} Published</span>
          </div>
          <div className="flex items-center gap-2">
